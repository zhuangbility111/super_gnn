...
from super_gnn.layers.gcnconv import DistGCNConvGrad
...
class DistGCN(torch.nn.Module):
    def __init__(
        ...
        self.convs.append(DistGCNConvGrad(in_channels, hidden_channels, num_bits, is_pre_delay))
        ...
        for _ in range(num_layers - 2):
            self.convs.append(DistGCNConvGrad(hidden_channels, hidden_channels, num_bits, is_pre_delay))
        ...
        self.convs.append(DistGCNConvGrad(hidden_channels, out_channels, num_bits, is_pre_delay))
