...
def process_vertex_list_part(G, matched_edges, unmatched_edges, targets, vertex_list_part, core_id):
    ...
    for v in vertex_list_part:
        ...
        if count % 100 == 0:
            print("The elapsed time for ", count, " vertices in ", tid, " is: ", elapsed_time, "s")
            elapsed_time = 0.0
...
def _connected_by_alternating_paths(G, matching, targets):
    ...
    print("The number of vertices in the graph is: ", len(vertex_list))
    ...
    #     p = Process(target=process_vertex_list_part, args=(G, matched_edges, unmatched_edges, targets, vertex_list_parts[pid], pid * 2, results[pid]))
    #     p.start()
    ...
    #     elapsed_time += end - begin
    #     if count % 100 == 0:
    #         print("The elapsed time for ", count, " vertices is: ", elapsed_time, "s", flush=True)
    #         elapsed_time = 0.0
...
def to_vertex_cover(G, matching, top_nodes=None):
    ...
    print("The elapsed time for connected by alternating paths is: ", end - begin, "s")
